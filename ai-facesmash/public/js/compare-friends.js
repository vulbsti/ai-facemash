...
document.addEventListener('DOMContentLoaded', function() {
    ...
    shareModal.innerHTML = `
        <div class="share-modal-content">
            <div class="share-modal-header">
                <h3 class="share-modal-title">Share Your Comparison</h3>
            ...
            <div class="share-options">
                <div class="share-option" id="shareInstagram">
                    ...
                    <div class="share-option-text">
                        ...
                        <p>Share this comparison to your Instagram story</p>
                    </div>
                </div>
    ...
    function shareToInstagram(imageDataUrl) {
        ...
        const file = new File([blob], 'facesmash-comparison.png', { type: 'image/png' });
        
        if (navigator.share && navigator.canShare && navigator.canShare({ files: [file] })) {
            navigator.share({
                files: [file],
                title: 'My AI Facesmash Comparison',
                text: 'Check out this AI comparison from Facesmash!'
            })
    ...
    function fallbackShare() {
        ...
        link.download = 'facesmash-comparison.png';
